...
const TESTIMONIALS = [
  {
    content: `Really good. I am so pleased with this product. I didn't even need training. 넘무 재밌는 글이 많아욥!`,
    author: {
      name: 'Clyde Edwards',
  ...
  {
    content: `It's really wonderful. I use saas product often. Thank You! Saas product has really helped our business. 자주 보러 올게욥!`,
    author: {
      name: 'Jimmy Hunter',
  ...
  {
    content: `Since I invested in saas product I made over 100,000 dollars profits. It really saves me time and effort. saas product is exactly what our business has been lacking. 언니 완전 예쁘당`,
    author: {
